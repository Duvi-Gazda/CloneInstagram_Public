<?php
// HTTP
define('HTTP_SERVER', 'http://local.llorry.shop/admin/');
define('HTTP_CATALOG', 'http://local.llorry.shop/');

// HTTPS
define('HTTPS_SERVER', 'http://local.llorry.shop/admin/');
...
define('DB_DATABASE', 'Attributer_5');
define('DB_PORT', '3306');
