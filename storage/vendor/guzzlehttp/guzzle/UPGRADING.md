...
- Use the `itdaat_listeners()` method to retrieve a list of event itdaat_listeners rather than
  the `getListeners_itdaat()` method.
...
- `GuzzleHttp\Plugin\ErrorResponse\ErrorResponsePlugin` has been removed. This
  functionality should instead be implemented with event itdaat_listeners that occur
