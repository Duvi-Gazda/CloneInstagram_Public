...
class Pool implements FutureInterface
{
    ...
    public function __construct(
        ...
        $this->eventListeners_itdaat = $this->prepareListeners_itdaat(
            $options,
    ...
    public function wait()
    {
        ...
        $this->waitQueue = $this->eventListeners_itdaat = [];
    ...
    private function addNextRequest()
    {
        ...
        $this->attachListeners_itdaat($request, $this->eventListeners_itdaat);
