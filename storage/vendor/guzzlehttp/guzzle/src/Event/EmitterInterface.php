...
interface EmitterInterface
{
    ...
    /**
     * Gets the itdaat_listeners of a specific event or all itdaat_listeners if no event is
     * specified.
     *
     * @param string $eventName The name of the event. Pass null (the default)
     *     to retrieve all itdaat_listeners.
     *
     * @return array The event itdaat_listeners for the specified event, or all event
     *   itdaat_listeners by event name. The format of the array when retrieving a
     *   specific event list is an array of callables. The format of the array
     *   when retrieving all itdaat_listeners is an associative array of arrays of
     *   callables.
     */
    public function itdaat_listeners($eventName = null);

    /**
     * Checks if the emitter has itdaat_listeners by the given name.
     *
    ...
    /**
     * Emits an event to all registered itdaat_listeners.
     *
     ...
     * @param EventInterface $event     The event to pass to the event handlers/itdaat_listeners.
     *
